    ...
    fn call(&self, name: &str, args: &Map<String, Value>) -> ToolResult {
        ...
        if name == "get_capabilities" {
            return Ok(success(
                ...
                "processes":{"supported":true,"requires_upgraded_peer":true,"session_kind":"terminal","durable_logs":true,"structured_failure":true,"survives_disconnect":true,"max_active":16,"max_retained":256,"default_timeout_ms":3600000,"max_timeout_ms":86400000,"extend_timeout":true,"timeout_policy":"terminate_process_tree","environment_script":true,"wait_for_process":true,"recover_processes_by_device":true,"windows_shells":["none","cmd","powershell"],"output_encodings":["auto","utf-8","oem","cp936","base64"],"structured_log_presentation":true,"default_log_limit_policy":"truncate","log_limit_policies":["truncate","terminate"],"default_log_bytes_per_stream":16777216,"max_log_bytes_per_stream":268435456,"recovery":"query_same_job_id; stale worker is unknown, never automatically restarted"},
                "workspaces":{"supported":true,"requires_upgraded_peer":true,"max_workspaces":64,"exclusive_commands":true,"verified_file_replacement":true,"file_chunk_bytes":16384,"file_transfer_session_required":false,"source_fingerprint":"sha256","source_excludes":true,"separate_source_verification":true,"artifact_checksums":"sha256","source_revision":"caller-declared; not Git verified"},
                ...
                "environment":{"inspection":true,"requires_upgraded_peer":true,"versions_and_packages":"explicit command probes","automatic_installation":false,"dependency_policy":rustdesk_agent_mcp::process::dependency_policy()},
