...
#[cfg(feature = "mcp")]
pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_rustdeskmcp.exe";
...
#[cfg(feature = "mcp")]
pub(super) const PRIVACY_WINDOW_CLASS: &'static str = "RustDeskMCPPrivacyWindowClass";
#[cfg(not(feature = "mcp"))]
pub(super) const PRIVACY_WINDOW_NAME: &'static str = "RustDeskPrivacyWindow";
#[cfg(feature = "mcp")]
pub(super) const PRIVACY_WINDOW_NAME: &'static str = "RustDeskMCPPrivacyWindow";
